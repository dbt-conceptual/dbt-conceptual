...
WITH source AS (
    SELECT
        ...
        initiative_status,
        is_deleted,
        {{ hashdiff(['initiative_title', 'initiative_description', 'initiative_status', 'is_deleted']) }} AS initiative_hd,
        load_ts,
        rsrc
