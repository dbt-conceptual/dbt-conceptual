...
WITH source AS (
    SELECT
        ...
        {{ hashdiff(['personality_version_code', 'personality_version_content']) }} AS personality_hd,
        load_ts,
        rsrc
