...
WITH source AS (
    SELECT
        ...
        current_sprint_code,
        is_deleted,
        {{ hashdiff(['ticket_title', 'ticket_description', 'ticket_tshirt_size', 'ticket_acceptance_criteria', 'ticket_current_status', 'project_code', 'current_sprint_code', 'is_deleted']) }} AS ticket_hd,
        load_ts,
        rsrc
