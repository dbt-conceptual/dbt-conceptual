...
WITH source AS (
    SELECT
        ...
        is_deleted,
        {{ hashdiff(['sprint_title', 'sprint_goal', 'sprint_started_at', 'sprint_planned_end_at', 'sprint_actual_end_at', 'is_deleted']) }} AS sprint_hd,
        load_ts,
        rsrc
