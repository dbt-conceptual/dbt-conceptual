...
WITH source AS (
    SELECT
        ...
        is_deleted,
        {{ hashdiff(['model_provider', 'model_context_window', 'model_input_cost_per_m', 'model_output_cost_per_m', 'model_cache_read_cost_per_m', 'model_cache_create_cost_per_m', 'is_deleted']) }} AS model_hd,
        load_ts,
        rsrc
